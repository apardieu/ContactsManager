...
namespace Services
{
    public class PersonsGetterServiceExcelWithLessFields : IPersonsGetterService
    {
        private readonly PersonsGetterService _personsGetterService;

        public PersonsGetterServiceExcelWithLessFields(PersonsGetterService personsGetterService)
        {
